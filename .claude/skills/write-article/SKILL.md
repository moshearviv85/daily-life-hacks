---
name: write-article
description: Write a new Daily Life Hacks article matching the established voice and SEO patterns. Use when the user asks to write, draft, or create an article, blog post, or content for daily-life-hacks.com, or mentions כתבה/מאמר in Hebrew.
---
