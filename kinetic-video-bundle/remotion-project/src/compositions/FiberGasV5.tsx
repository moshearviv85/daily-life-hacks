/**
 * dlh-fiber-gas V5 — "Dead Guts Don't Bloat"
 * V4 + cross-fade image transitions (0.5s dissolve) + aggressive Ken Burns (8%-22%) + horizontal drift.
 */
...
export const FiberGasV5: React.FC = () => {
