/**
 * dlh-cabbage V2 — "The gut food you've been ignoring costs a dollar fifty"
 * v2 improvements: falling stack display, more orange, long word fix
 */
...
export const CabbageV2: React.FC = () => {
