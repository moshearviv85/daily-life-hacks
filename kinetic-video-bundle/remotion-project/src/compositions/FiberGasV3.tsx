/**
 * dlh-fiber-gas V3 — "Dead Guts Don't Bloat"
 * Charlie voice speed 1.1, stability 0.30, style 0.45. Trap energetic music.
 * CAPS words (WRONG MOVE, DEAD GUTS, FLOOD, FOUR WEEKS) → hero orange large.
 * img0=explosion (0s), img1=veg (2.4s), img5=microscope (16.2s),
 * img2=broccoli (21.3s), img3b=apple in fridge (23.6s), img4=oatmeal (25.5s)
 * Outro at 33.0s.
 */
...
export const FiberGasV3: React.FC = () => {
    ...
    <AbsoluteFill>
      <KineticShortComposition
        ...
        imageCues={[
          ...
          { time: 16.2, src: 'dlh-fiber-gas/images/img5.jpg' }, // microscope — "bacteria"
