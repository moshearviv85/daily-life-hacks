/**
 * dlh-cabbage V1 — "The gut food you've been ignoring costs a dollar fifty"
 * Single custom 9:16 background image (bg-v1.jpg) throughout.
 * Voice: q0IMILNRPxOgtBTS4taI | Music: Upbeat Electric Guitar
 */
...
export const CabbageV1: React.FC = () => {
