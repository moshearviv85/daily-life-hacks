/**
 * dlh-healthy-fats V3 - "The Fat Lie" David Miller style
 * Roger voice, speed 0.95, style 0.25 — dry, natural, slightly cynical.
 * Lo-fi chill background music — supports, doesn't compete.
 * Outro at 37.2s: white bg + logo + URL.
 */
...
export const HealthyFatsV3: React.FC = () => {
  ...
  return (
    <AbsoluteFill>
      <KineticShortComposition
        ...
        musicFile="dlh-healthy-fats/music-v3.mp3"
        musicVolume={0.14}
        imageCues={[
