...
export const FLAGSHIP_ENGAGEMENT = {
  "protein-per-dollar-cheapest-protein-sources": {
    ...
    emailCapture: {
      ...
      text: "Next scheduled re-audit is October 2026. Monthly BLS checks flag drift before then. If whole wheat flour or chicken drumsticks change places, that's the note. Same newsletter as the footer form. Unsubscribe whenever.",
