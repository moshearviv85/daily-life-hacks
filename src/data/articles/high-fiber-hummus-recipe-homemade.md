...
- '**Serve It Up:** Transfer the creamy hummus to a serving bowl. Drizzle generously
  ...
  crunchy crackers.'
faq:
- question: How do you make homemade hummus creamy?
  answer: Process the chickpeas and tahini for a full 1-2 minutes, then add reserved chickpea liquid or ice water 1 tablespoon at a time. Stopping after 20 seconds is how you get beige gravel.
- question: Do you need to peel chickpeas for hummus?
  answer: No. Peeling can make hummus smoother, but it also turns a 10-minute recipe into a small unpaid internship. A food processor and enough blending time handle the skins well.
- question: Can I make hummus with another bean?
  answer: Yes. White beans make a mild, creamy dip, while black beans create a darker, earthier version. Start with the same 2-can amount and adjust the lemon and water after blending.
- question: Can homemade hummus be frozen?
  answer: Freeze it in an airtight container with a little space at the top for up to 3 months. Thaw it in the refrigerator, stir well, and add a spoonful of water if the texture looks thick.
- question: What can I serve with homemade hummus?
  answer: Pita, carrots, cucumber, bell pepper, crackers, or a spoon all work. Vegetables add crunch, while warm pita makes the bowl disappear suspiciously fast.
---
...
Most grainy hummus simply hasn't been processed long enough. The first 20 or 30 seconds break the chickpeas apart, but they don't make them smooth. Let the processor run for one to two minutes, scrape the bowl, and run it again if you can still see coarse bits.

Tahini matters too. Stir the jar before measuring because the sesame solids settle while the oil floats on top, apparently determined to make you dirty another spoon. Half a cup may look generous, but it gives two cans of chickpeas the richness they need.

## Do you need to peel chickpeas for smooth hummus?

You can peel them. I won't. Removing the skin from every chickpea creates a slightly silkier dip, but it also turns lunch into a craft project.

Rinse the canned chickpeas thoroughly, drain them, and let the food processor do the work. Keep about 1/4 cup of the can liquid before rinsing. You'll add it gradually, so don't dump the whole amount in and hope the blender understands your intentions.

## When should you add ice water?

Add the olive oil while the processor is running, then spoon in the reserved chickpea liquid one tablespoon at a time. If the hummus still looks thick, add one tablespoon of ice water and process again. Add the second only if you need it.

Cold water helps loosen the mixture and makes it look lighter. The exact amount changes with the chickpeas and tahini, so trust the texture in front of you. Hummus should mound on a spoon, then relax a little. If it stands upright like spackle, keep going.

## How do you fix bland hummus?

Taste after the texture is right. More lemon makes it brighter. More salt makes the chickpeas and tahini taste like themselves instead of beige paste. Add either in small amounts and process for a few seconds before tasting again.

Raw garlic gets stronger as the hummus sits, so don't keep adding cloves because the first taste seems mild. Two or three cloves are enough for this batch. Cumin stays in the background at 1/2 teaspoon, which is where it belongs. This is hummus, not a cumin delivery system.

Paprika or sumac on top is optional. The olive oil drizzle isn't required either, but it makes the bowl look finished and gives pita something to drag through.
