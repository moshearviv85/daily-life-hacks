...
The six foods below the cutoff, in order: TVP at 22.5 grams per dollar, canned chickpeas at 22.0, frozen shelled edamame at 18.0, almonds at 14.8, extra firm tofu at 13.6, and tempeh at 13.2.
...
One fair objection to a plant-only ranking: these foods vary in protein quality, and a straight per-gram list ignores that. So we reran it with digestibility factored in, [protein per dollar adjusted for quality using DIAAS](/protein-per-dollar-adjusted-for-quality/), and beans still landed on top even after the haircut. The pattern matches everything else we've priced: the cheapest protein in the store doesn't come in branded packaging, it comes in a clear bag with a bland label. For the full playbook on turning these numbers into actual dinners, start with our [high protein on a budget guide](/high-protein-on-a-budget-complete-guide/). The [high-protein budget meals](/high-protein-meals-on-a-budget/) page turns the ranking into plates with a price per 30 grams, and [what 50 grams of protein costs per day](/what-50-grams-of-protein-costs-per-day/) runs the whole-day math.

<!-- numbers-source: pipeline-data/derived-studies/plant-protein-per-dollar-ranked.json -->
