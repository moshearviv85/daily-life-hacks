...
- 'Toppings: shredded cabbage or lettuce, salsa, lime wedges, cilantro, avocado or
  crema (optional)'
steps:
- In a medium skillet over medium heat, add the black beans, cumin, chili powder,
  garlic powder, and water or lime juice. Mash about half the beans with the back
  of a fork and stir. Cook 5–7 minutes until heated through and slightly thickened.
- Warm tortillas in a dry skillet or wrapped in a damp towel in the microwave.
- Spoon bean mixture into tortillas and add toppings as you like. Serve with lime
  wedges.
faq:
- question: Why do I need to mash the black beans?
  answer: Mashing about half of the beans is the trick to a great easy black bean
    tacos weeknight dinner. It creates a thicker, creamier texture so the beans actually
    stay inside the tortilla instead of rolling out onto your plate.
...
Black beans are an unsung hero of the pantry. They are incredibly cheap, shelf-stable, and bring a heavy dose of both protein and fiber to the table: [a single 15.5 ounce can runs about 26.5 grams of protein](/how-much-protein-in-a-can-of-beans/), so two cans feed a table without anyone missing the beef. The dry bag is cheaper still, which is why beans keep clustering near the top of the [protein per dollar ranking](/protein-per-dollar-cheapest-protein-sources/) and the [fiber per dollar ranking](/fiber-per-dollar-cheapest-high-fiber-foods/). 
