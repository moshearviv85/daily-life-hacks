---
title: Hearty Vegetarian Chili with Three Beans and Corn
excerpt: A properly thick vegetarian chili that actually fills you up. Three beans, real corn, and a seasoning approach that doesn't taste like a compromise.
category: recipes
tags:
- vegetarian chili
- three bean chili
...
- meal prep chili
- meatless chili
image: "/images/hearty-vegetarian-chili-with-three-beans-and-corn-main.jpg"
imageAlt: A ceramic bowl filled with thick vegetarian three-bean chili topped with cilantro and cheese, with corn, kidney beans, and black beans visible in the rich tomato sauce.
date: 2026-07-02
author: "David Miller"
featured: false
prepTime: "20 mins"
...
steps:
- Heat olive oil in a large Dutch oven or heavy pot over medium heat. Add the onion and cook until softened, about 5 minutes.
- Add the garlic and cook until fragrant, about 1 minute. Stir in the bell peppers and cook for 3-4 minutes until slightly softened.
- Add the chili powder, cumin, smoked paprika, garlic powder, onion powder, and cayenne if using. Stir for 30 seconds until the spices are toasted and fragrant.
- Pour in the diced tomatoes and tomato sauce, scraping up any browned bits from the bottom of the pot.
- Add all three types of beans (kidney, black, and pinto) and stir to combine.
- Bring the mixture to a simmer, then reduce heat to low. Cover partially and cook for 35-40 minutes, stirring occasionally.
- During the last 10 minutes of cooking, stir in the frozen corn kernels.
- Remove from heat and stir in the lime juice. Season with salt and black pepper to taste.
- Serve hot, topped with your choice of garnishes like sour cream, shredded cheese, avocado, or fresh cilantro.
faq:
  - question: "Can I use fresh corn instead of frozen?"
    answer: "Fresh corn works well when it's in season. Cut the kernels from 2-3 ears and add them during the last 15 minutes of cooking so they stay crisp-tender. Frozen corn is more convenient and actually holds up better in a long simmer."
  - question: "Is this chili spicy?"
    answer: "The base recipe is mildly warm rather than hot. The cayenne is optional, so leave it out if you're cooking for kids or prefer no heat. You can always add more at the table."
  - question: "How long does this chili last in the fridge?"
    answer: "Stored in an airtight container, this chili keeps well for 5 days. The flavors actually improve after a day or two as the seasonings meld."
  - question: "Can I freeze vegetarian chili?"
    answer: "Yes, this freezes beautifully for up to 3 months. Let it cool completely before freezing in airtight containers. Thaw overnight in the fridge and reheat on the stove or in the microwave."
  - question: "What makes this chili hearty instead of watery?"
    answer: "The combination of three beans that have been drained and rinsed, plus simmering uncovered for the last 10 minutes, creates that thick, spoonable texture. Using tomato sauce instead of just diced tomatoes also helps."
---
