...
quickAnswer: >-
  ...
  off visible smoke, and the first thing to know is that the two big US tables
  measure refined, deodorized oil only. The ISEO lab table lists palm at 489°F,
  high-oleic sunflower 471°F, soybean, lard and high-oleic canola 464°F,
  low-linolenic soybean 458°F, canola 457°F, corn 455°F, peanut 446°F and
  coconut 385°F. USDA FSIS runs lower and groups oils together: peanut,
  safflower and soybean at 450°F, corn, olive, sesame and sunflower at 410°F.
  Neither tested a virgin or cold-pressed sample, so no US lab table covers
  them, but a 2021 study in Frontiers in Nutrition ran ten expeller-pressed
  oils through the same AOCS method and got 228°F for sunflower and 287°F for
  peanut, far under their refined twins. UC Davis puts olive oil at 347°F to
  464°F by grade. Every one of those is a single lab reading, so cook with a
  margin below it.
category: "nutrition"
tags:
- cooking basics
...
faq:
  - question: "What does smoke point mean for cooking oil?"
    answer: "USDA FSIS describes the smoke point as the temperature where an oil begins to break down and can develop a foul odor or taste. A 2025 study in Foods adds that smoke point marks the onset of thermal degradation, and that it's still judged by eye, which makes it less precise than a single printed number suggests."
  - question: "Which cooking oil has the highest smoke point?"
    answer: "In the ISEO lab table, refined palm oil is highest at 489°F, followed by high-oleic sunflower at 471°F and soybean, lard and high-oleic canola at 464°F. Refined avocado oil is often advertised near 520°F, but that figure doesn't appear in the ISEO or USDA FSIS tables, so treat it as a producer claim. The closest thing to a sourced avocado number comes from AOCS researchers writing in Inform, who put extra virgin avocado oil at 250°C or higher, roughly 482°F."
  - question: "Do virgin and cold-pressed oils have lower smoke points?"
    answer: "Lower, and now there are numbers. Neither ISEO nor USDA FSIS tested an unrefined sample, but a 2021 study in Frontiers in Nutrition pressed ten oilseeds and ran the same AOCS Cc 9a-48 test, getting 228°F for sunflower, 287°F for peanut, 299°F for walnut and 343°F for cold-pressed black sesame. Compare that to 471°F refined high-oleic sunflower and 446°F refined peanut. ISEO notes some unrefined oils carry as much as several percent free fatty acids against under 0.1% once refined, and a 2025 study in Foods found free fatty acids drive the smoke point down."
  - question: "Is extra virgin olive oil good for cooking?"
    answer: "UC Davis food scientists say olive oil cooks well and that its smoke point can be comparable to canola, rice bran and high-oleic peanut, with the full olive range running 347°F to 464°F by grade, quality and freshness. Extra virgin is unrefined, so it sits lower in that band than refined olive oil."
  - question: "Should I throw away oil that smoked in the pan?"
    answer: "For one quick wisp you caught fast, pull the pan off the heat and carry on. USDA FSIS says to discard frying oil that's clouded, foaming, or off in odor or taste. Repeated heating raises an oil's free fatty acid content, and ISEO notes that lowers the smoke point each time around."
---
...
Two published tables do the work. The [Institute of Shortening and Edible Oils tested deodorized samples at 0.05% free fatty acids or less, using AOCS Method Cc 9a-48](https://edibleoilproducers.org/wp-content/uploads/2025/03/foodfatsoils2016.pdf) (Table VIII, page 21). [USDA FSIS publishes a shorter deep-frying list](https://www.fsis.usda.gov/food-safety/safe-food-handling-and-preparation/food-safety-basics/deep-fat-frying), some rows grouping several oils together, with no refinement level stated.
...
Real figures do exist, though. A [2021 study in *Frontiers in Nutrition* pressed ten oilseeds and measured smoke points with that same AOCS Cc 9a-48 method](https://pmc.ncbi.nlm.nih.gov/articles/PMC8566681/). Every row below names its publisher and its evidence tier, so you can weigh it yourself.
...
| Avocado, extra virgin cold-pressed | 482°F or higher (≥250°C) | [AOCS *Inform*, Wong et al., 2010](https://www.aocs.org/stay-informed/inform-magazine/featured-articles/what-is-unrefined-extra-virgin-cold-pressed-avocado-oil-april-2010) | Researchers writing in a trade journal, no test table shown |
| Coconut, virgin | [350°F to 390°F](https://drbronner.gorgias.help/en-US/what-is-the-smoke-point-of-the-virgin-coconut-oil-518046) | Dr. Bronner's | Producer help page, no test method published |
...
Mostly free fatty acids. A 2025 study in *Foods* measured 48 virgin olive oils and found [free fatty acid content was the main determinant of the smoke point, with a strong inverse relationship](https://pmc.ncbi.nlm.nih.gov/articles/PMC12692607/). Refining strips them out, which is why refined oils read higher.
...
It tells you when smoke shows up, not how the oil holds up chemically. [UC Davis food scientists say olive oil cooks well and that good extra virgin has natural antioxidants that resist heat](https://ucfoodquality.ucdavis.edu/olive-oil/olive-oil-myths-and-facts), even though plenty of neutral oils out-measure it on paper.

Heat does change oil. A 2025 review in *Food Chemistry: X* describes how [thermal oxidation can form aldehydes including acrolein, and notes deep frying typically runs 150 to 190°C](https://pmc.ncbi.nlm.nih.gov/articles/PMC12281009/), roughly 302°F to 374°F. It links long-term cooking-fume exposure with respiratory risk, so a running hood fan may matter more than the bottle.
...
**Searing and stir-frying.** Refined soybean, canola, high-oleic sunflower, peanut or olive. Same oils that work for [seasoning a cast iron skillet](/how-to-season-cast-iron-skillet-properly/).

**Roasting at 375°F to 425°F.** Extra virgin olive oil, canola, vegetable oil.

**Dressings and finishing.** Extra virgin olive oil, toasted sesame, walnut. Flavor is the whole job, and oil residue is why [cleaning a blender without scrubbing](/how-to-clean-blender-fast-no-scrub/) is worth learning.
...
Two bottles cover most of home cooking: extra virgin olive oil and one neutral refined oil. A third of toasted sesame earns its space a teaspoon at a time, same small-lever trick as [cinnamon or citrus instead of sugar](/add-flavor-without-more-sugar-tricks/).
...
**Trusting an avocado oil label.** In the first extensive US study of the category, [UC Davis found at least 82% of avocado oil samples were stale before their expiration date or mixed with other oils](https://www.ucdavis.edu/food/news/study-finds-82-percent-avocado-oil-rancid-or-mixed-other-oils), including three labeled "pure" or "extra virgin" that tested near 100% soybean. FDA has set no standards of identity here, which is how that happens.
...
* [ISEO: *Food Fats and Oils*, Table VIII](https://edibleoilproducers.org/wp-content/uploads/2025/03/foodfatsoils2016.pdf)
* [USDA FSIS: Deep Fat Frying](https://www.fsis.usda.gov/food-safety/safe-food-handling-and-preparation/food-safety-basics/deep-fat-frying)
* [UC Davis: Olive Oil Myths and Facts](https://ucfoodquality.ucdavis.edu/olive-oil/olive-oil-myths-and-facts)
* [UC Davis: 82% of Avocado Oil Rancid or Mixed](https://www.ucdavis.edu/food/news/study-finds-82-percent-avocado-oil-rancid-or-mixed-other-oils)
* [*Frontiers in Nutrition* (2021): smoke points of ten cold-pressed oils](https://pmc.ncbi.nlm.nih.gov/articles/PMC8566681/)
* [AOCS *Inform* (2010): unrefined, extra virgin cold-pressed avocado oil](https://www.aocs.org/stay-informed/inform-magazine/featured-articles/what-is-unrefined-extra-virgin-cold-pressed-avocado-oil-april-2010)
* [*Foods* (2025): Smoke Point in Virgin Olive Oils](https://pmc.ncbi.nlm.nih.gov/articles/PMC12692607/)
* [*Food Chemistry: X* (2025): Toxic aldehydes in cooking oils](https://pmc.ncbi.nlm.nih.gov/articles/PMC12281009/)
