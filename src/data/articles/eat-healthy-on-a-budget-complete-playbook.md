...
Most budget eating advice is somebody's opinion. We wanted receipts, so we built two datasets: 49 foods ranked by [protein per dollar](/protein-per-dollar-cheapest-protein-sources/) and 53 foods ranked by [fiber per dollar](/fiber-per-dollar-cheapest-high-fiber-foods/). The current row-level audits found 38 exact USDA matches, 4 close USDA proxies, and 11 unresolved rows in the fiber file; the protein file has 36 exact USDA matches, 5 close USDA proxies, and 8 unresolved rows. The TVP row is unresolved: the protein file retains a recorded 50.0 grams per 100 grams, but the current product page works out to about 52.2. We matched the datasets to July 2026 prices, then published the spreadsheets so anyone can check the math and the open source gaps.
...
* **[Beans and rice](/beans-and-rice-complete-protein-meal/):** the classic pairing where the legume and the grain cover each other's amino acid gaps. Costs almost nothing, keeps you full.
* **[One pot chicken and rice](/easy-one-pot-chicken-and-rice-dinner/):** drumstick-friendly, one pan to wash, and it reheats better than it has any right to.
* **[Low-cost protein meal hacks](/low-cost-protein-meal-hacks-families/):** the tricks for making eggs, canned fish, and beans feel like dinner instead of a compromise.
...
1. **Sunday:** batch day. A pot of beans, a pot of rice, split pea soup in the slow cooker. Dinner is drumsticks roasted alongside. Maybe $6 of ingredients cooked, three days covered.
2. **Monday:** split pea soup with bread. The soup pot cost about $3 total and feeds you twice.
3. **Tuesday:** beans and rice night, dressed up with whatever the produce drawer offers. Roughly $2.50 for two plates.
4. **Wednesday:** one pot chicken and rice with frozen peas. Around $4.
5. **Thursday:** leftovers, on purpose. Fried rice from Tuesday's extra rice, an egg on top. Nearly free.
6. **Friday:** pasta night. Whole wheat spaghetti, canned tomatoes, whatever vegetables need using. About $3.50.
7. **Saturday:** the flex night. Beans become chili, or the freezer offers something up. This is also where the leftover drumsticks land.
