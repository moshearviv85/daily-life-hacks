...
author: "David Miller"
faq:
  - question: "What is the cheapest complete protein combination?"
    answer: "In our 20-pair ranking, dry pinto beans plus whole wheat flour delivered 97.0 grams of protein per dollar, splitting each dollar 50/50 between the two foods at July 2026 prices. Legumes and grains complement each other's amino acid profiles, which is why these pairings get the complete-protein label in the first place."
  - question: "Do rice and beans make a complete protein?"
    answer: "The traditional claim is that legumes and grains complement each other's amino acid profiles, so the pairing may cover what either food is lighter on alone. In our pricing, the classic version of the pair, dry pinto beans with brown rice, delivered 67.2 grams of protein per dollar on a 50/50 dollar split."
  - question: "How much protein does a dollar of rice and beans buy?"
    answer: "About 67.2 grams for pinto beans with brown rice, using a 50/50 dollar split and July 2026 prices. That single dollar buys more than the FDA's 50 gram protein Daily Value. Swap the rice for whole wheat flour and the same dollar climbs to 97.0 grams, if you're willing to bake."
  - question: "What does a 50/50 dollar split mean in this ranking?"
    answer: "Each pair is scored as if you spent 50 cents on the legume and 50 cents on the grain, then added up the protein grams that full dollar buys. It's a simple way to compare pairs fairly, since it doesn't let one cheap ingredient carry the whole score."
  - question: "Is there a bad pair on this list?"
    answer: "Not really. The weakest of the 20 pairs, green split peas with pearled barley, still delivered 55.1 grams of protein per dollar, above the FDA's 50 gram Daily Value. The spread from best to worst is only 1.8x, so any legume plus grain combination you'll actually cook may be a reasonable pick."
---
...
The one that becomes a meal you'll repeat. [Beans and rice](/beans-and-rice-complete-protein-meal/) is the obvious starting point, 67.2 grams of protein per dollar in its pinto-and-brown-rice form, and it doesn't need a motivational speech. If you'd rather see that in dry weights than in dollars, [one adult's day runs about a cup of dry beans and two thirds of a cup of dry rice](/how-much-rice-and-beans-per-person-per-day/). Lentils with rice is the speed play, since lentils skip the soak entirely: [a one-pot dal over rice](/simple-lunch-recipes-indian-veg/) is the weeknight version of this whole article. And if you want the batch-cooking angle, [20 minute bean and rice meals](/quick-20-minute-high-fiber-meals-for-busy-days/) is the same math wearing a meal-prep container.
...
The legume half of every pair is also doing fiber work while it sits in the pot, which we scored separately in [protein and fiber per dollar across ten beans and lentils](/beans-double-win-fiber-protein/) and across the whole store in the [fiber per dollar ranking](/fiber-per-dollar-cheapest-high-fiber-foods/). If you're building actual meals out of this, the [high protein on a budget guide](/high-protein-on-a-budget-complete-guide/) is the full playbook, and [what 50 grams of protein costs per day](/what-50-grams-of-protein-costs-per-day/) prices out the daily version. The short answer stays the same either way: buy a bag of beans, buy a bag of something grainy, and let two of the cheapest foods in the store cover for each other.
