...
export function validateDataFoundation() {
  ...
  if (publicResources.length !== 22) {
    errors.push(`public datapackage has ${publicResources.length} resources, expected 22`);
  }
  ...
  if (rowTotal !== 474) {
    errors.push(`CSV row total is ${rowTotal}, expected 474`);
  }
