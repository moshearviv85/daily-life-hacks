...
from lib.content_policy import (
    EM_DASH,
    SUPPLEMENT_PATTERNS,
    AI_WORDS_BANNED as BANNED_AI_WORDS,
    ABSOLUTE_HEALTH_PATTERNS as MEDICAL_CLAIM_PATTERNS,
    DETOX_PATTERNS,
    SIGNOFF_PATTERNS,
    REQUIRED_FIELDS as REQUIRED_FRONTMATTER_FIELDS,
)

# --- Local regex constants (not in content_policy) ---
